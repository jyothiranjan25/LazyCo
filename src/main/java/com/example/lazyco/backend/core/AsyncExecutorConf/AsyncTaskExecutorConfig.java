...
public class AsyncTaskExecutorConfig implements AsyncConfigurer, DisposableBean {
    ...
    private static class CustomSecurityContextAsyncTaskExecutor implements org.springframework.core.task.AsyncTaskExecutor {
        private final org.springframework.core.task.AsyncTaskExecutor delegate;

        public CustomSecurityContextAsyncTaskExecutor(org.springframework.core.task.AsyncTaskExecutor delegateAsyncTaskExecutor) {
