    ...
    public Object trackTransaction(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        TransactionSynchronizationManager.registerSynchronization(new TransactionSynchronization() {
            ...
            public void flush() {
                ...
                ApplicationLogger.debug(String.format(
                        "Flushing changes in method '%s' of class '%s'",
                        methodName, className));
            }
            ...
            public void suspend() {
                ApplicationLogger.debug(String.format(
                        "Transaction suspended in method '%s' of class '%s'",
                        methodName, className));
            }
            ...
            public void resume() {
                ApplicationLogger.debug(String.format(
                        "Transaction resumed in method '%s' of class '%s'",
                        methodName, className));
            }
            ...
            public void savepoint(Object savepoint) {
                ApplicationLogger.debug(String.format(
                        "Savepoint( '%s' ) created in method '%s' of class '%s'",savepoint,
                        methodName, className));
            }
            ...
            public void savepointRollback(Object savepoint) {
                ApplicationLogger.debug(String.format(
                        "Rolled back to savepoint( '%s' ) in method '%s' of class '%s'",savepoint,
                        methodName, className));
            }
        });
