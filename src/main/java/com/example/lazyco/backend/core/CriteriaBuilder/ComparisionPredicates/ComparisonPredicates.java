...
public interface ComparisonPredicates {
    Predicate getGePredicate(HibernateCriteriaBuilder criteriaBuilder, Expression<?> expression, Object value);

    Predicate getLePredicate(HibernateCriteriaBuilder criteriaBuilder, Expression<?> expression, Object value);

    Predicate getGtPredicate(HibernateCriteriaBuilder criteriaBuilder, Expression<?> expression, Object value);

    Predicate getLtPredicate(HibernateCriteriaBuilder criteriaBuilder, Expression<?> expression, Object value);
