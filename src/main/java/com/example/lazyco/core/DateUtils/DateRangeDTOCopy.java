...
public class DateRangeDTOCopy {
   ...
   */
  public DateRangeDTOCopy(Date start, Date end) {
    setStart(start);
    setEnd(end);
    validateRange();
  }
   ...
   * @param end the end date (inclusive), must not be null
   */
  public DateRangeDTOCopy(String start, String end) {
   ...
   */
  public DateRangeDTOCopy(LocalDate startDate, LocalDate endDate) {
   ...
   */
  public DateRangeDTOCopy(LocalDate startDate, LocalDate endDate, ZoneId zoneId) {
   ...
   */
  public boolean overlaps(DateRangeDTOCopy other) {
   ...
   */
  public boolean isBefore(DateRangeDTOCopy other) {
    Objects.requireNonNull(other, "Other range cannot be null");
   ...
   */
  public boolean isAfter(DateRangeDTOCopy other) {
    Objects.requireNonNull(other, "Other range cannot be null");
   ...
   */
  public DateRangeDTOCopy intersect(DateRangeDTOCopy other) {
    Objects.requireNonNull(other, "Other range cannot be null");
    ...
    return new DateRangeDTOCopy(intersectionStart, intersectionEnd);
  }
   ...
   */
  public DateRangeDTOCopy union(DateRangeDTOCopy other) {
    Objects.requireNonNull(other, "Other range cannot be null");
    ...
    return new DateRangeDTOCopy(unionStart, unionEnd);
  }

  /** Check if this range is adjacent to another (end of one is start of the other). */
  private boolean areAdjacent(DateRangeDTOCopy other) {
