...
public interface StudentFormSectionCustomFieldMapper
    extends AbstractMapper<StudentFormSectionCustomFieldDTO, StudentFormSectionCustomField> {

  @Mapping(target = "studentFormPageSectionId", source = "studentFormPageSection.id")
  ...
  StudentFormSectionCustomFieldDTO map(StudentFormSectionCustomField entity);
}
